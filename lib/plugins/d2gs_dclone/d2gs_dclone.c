...
static const char *pina_colada_song[] = {
...
static pthread_mutex_t d2gs_cleanup_m;
static pthread_cond_t d2gs_cleanup_cv;

static int hits;

static void thread_idle(int s) {
	struct timespec ts;
...
static int on_mcp_join_game(void *p) {
...
static int on_d2gs_cleanup(void *p) {
...
static int on_d2gs_chat(void *p) {
